...
const planetsData = [
    {
        name: "Planner",
        description: "Organize your life, tasks, and goals in one beautiful interface. Stay on top of your schedule and achieve your dreams.",
        features: [
        ...
        color: 0x667eea,
        url: "https://your-planner-url.github.io",
        orbitRadius: 8,
        size: 1.2,
        orbitSpeed: 0.0008
    },
    {
        name: "Budgeter",
        description: "Take control of your finances with smart budgeting tools. Track expenses, set savings goals, and build wealth.",
        features: [
            "Expense tracking",
            "Budget planning",
            "Savings goals",
        ...
        color: 0x48bb78,
        url: "https://your-budgeter-url.github.io",
        orbitRadius: 12,
        size: 1.4,
        orbitSpeed: 0.0006
    },
    {
        name: "Skills Tracker",
        description: "Level up your abilities and track your learning journey. Master new skills and celebrate your growth.",
        features: [
        ...
        color: 0xf093fb,
        url: "https://your-skills-tracker-url.github.io",
        orbitRadius: 16,
        size: 1.1,
        orbitSpeed: 0.0004
    },
    {
        name: "Bible Memory",
        description: "Strengthen your faith by memorizing scripture. Build a strong foundation in God's Word with interactive tools.",
        features: [
            "Verse memorization",
            "Daily devotionals",
            "Progress tracking",
        ...
        color: 0xfbd38d,
        url: "https://your-bible-memory-url.github.io",
        orbitRadius: 20,
        size: 1.3,
        orbitSpeed: 0.0003
    }
...
function openPlanetModal(data) {
    ...
    planetIcon.style.background = `radial-gradient(circle at 30% 30%, ${rgbToString(data.color)}, transparent)`;
    planetIcon.style.boxShadow = `0 0 40px ${rgbToString(data.color)}, inset 0 0 30px ${rgbToString(data.color)}`;
